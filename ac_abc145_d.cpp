...
/* ///////////////////////// writeup1 start
# 前提知識
- [二項係数 mod 素数を高速に計算する方法](https://www.hamayanhamayan.com/entry/2018/06/06/210256)
///////////////////////// writeup2 start
400点にしては問題が難しい感じがする。
何か全探索対象を探そう。
...
まずはこれを求める。
連立方程式を真面目に解いてもいいが、X,Yが10^6までなので、aを全探索して探せばいい。
a,bで0以上の整数の解が見つからなければ0が答え。

あとは、Aがa個、Bがb個ある経路の組み合わせを求める。
これはちょうどC(a+b,a)となる。
mod10^9+7で二項係数を高速に求める方法は知られているので、それを使うと答え。
///////////////////////// writeup2 end */
